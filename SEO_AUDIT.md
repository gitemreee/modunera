...
| P1 | Guide inflation: 50 topic families each split into Leitfaden + Fehler-Checkliste (+ third variant); intra-family duplication measured 0.29–0.55 Jaccard — the same intent split 2–3 ways, 112 indexable blog folders | high | med | low | Merge per family into one guide, fold checklist in as section, 301 the rest. Plan with per-family measurements: `CONTENT_PRUNING_PLAN.md` | **EXECUTED 2026-08-25** (52 URLs pruned) |
| P1 | Lead capture is WhatsApp-only; a buyer who won't open WhatsApp leaves nothing | – | – | high | Netlify Forms live on /kontakt/: honeypot, consent, WhatsApp parallel | **FIXED 2026-08-27** |
| P1 | Homepage ships 3.26 MB images desktop / 2.43 MB mobile; local LCP 2.07s desktop (element: aframe-olive-grove-760.webp) — real-network LCP will exceed 2.5s on 4G | med | med | med | -900 siblings for the gallery heavies (tools/make_image_derivatives.py) + site-wide srcset and inline-bg swap in build-image-attrs.mjs. Home images 3.26→2.16 MB desktop, 2.43→1.84 MB mobile | **FIXED 2026-08-27** |
| P1 | 531 titles >60 chars remain (down from 1,506) — mostly blog editorial; per-title judgement | med | high | – | Policy rules (phrase trims, colon-tail, country-tail) in build-title-lengths.mjs: 497→146, remainder are exempt news/praxis story titles | **FIXED 2026-08-27** |
...
| P2 | 248 descriptions >160 chars | – | med | – | Sentence-aware trim in the same pass: 248→0 | **FIXED 2026-08-27** |
| P2 | Title collisions: da/fr Luxembourg pages share one title; "Au" (ZH) vs "Au" (SG) share; fr/nl bungalows share | low | low | – | Duplicate place names now carry their region ("Au (Zürich)"); done in build-modunera-europe.mjs | **FIXED 2026-08-27** |
