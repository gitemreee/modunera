...
COVERS = [
    dict(slug="modelle", label="MODELLE", icon=icon_house,
         ground=g.MOSS_DEEP, ink=g.CREAM, link="modunera.com/modelle",
         note="Eight models, MD 1 to MD 8"),
    dict(slug="preise", label="PREISE", icon=icon_tag,
         ground=g.PAPER, ink=g.ROOF, link="modunera.com/tiny-house-preise",
         note="Configure a model and plan a budget"),
    dict(slug="ratgeber", label="RATGEBER", icon=icon_book,
         ground=g.MOSS, ink=g.CREAM, link="modunera.com/ratgeber",
         note="110 articles by subject"),
    dict(slug="europa", label="EUROPA", icon=icon_pin,
         ground=g.CREAM, ink=g.MOSS_DEEP, link="modunera.com/laender",
         note="Germany, Netherlands, Denmark, Luxembourg, Switzerland"),
    dict(slug="qualitaet", label="QUALITÄT", icon=icon_leaf,
         ground=g.CHARCOAL, ink=g.SAGE, link="modunera.com/qualitaet",
         note="Steel, windows, façade, materials"),
    dict(slug="produktion", label="PRODUKTION", icon=icon_layers,
         ground=g.ROOF, ink=g.WHITE, link="modunera.com/factory",
         note="Own production, five phases"),
    dict(slug="projekte", label="PROJEKTE", icon=icon_frame,
         ground=g.SAGE, ink=g.MOSS_DEEP, link="modunera.com/projects",
         note="Living, holiday, office, glamping"),
    dict(slug="faq", label="FAQ", icon=icon_bubble,
         ground=g.PAPER, ink=g.MOSS_DEEP, link="modunera.com/faq",
         note="160 answers on buying, technics and delivery"),
    dict(slug="natur", label="NATUR", icon=icon_flame,
         ground=g.CHARCOAL, ink=g.CREAM, link=None,
         note="Care on wooded sites. Not a sales highlight."),
]
