...
function servicesIndex(lang) {
  ...
  const title = isDe ? "Tiny Houses, Modulbau, Stahlbau, Bungalows & Möbel | MODUNERA" : "Tiny houses, modular, steel, bungalows & furniture | MODUNERA";
  const description = isDe ? "Die fünf Dinge, die MODUNERA fertigt: Tiny Houses als Kern, dazu Modulbau, Stahlkonstruktionen, Bungalows und maßgefertigte Möbel." : "The five things MODUNERA builds: tiny houses at the core, plus modular buildings, steel structures, bungalows and bespoke furniture.";
  return head({ file, lang, title, description, alternateDe: BASE + "leistungen/", alternateEn: BASE + "en/services/" }) + nav(root, lang) + `<main id="main"><header class="page-hero"><div class="container"><div class="eyebrow">${isDe ? "Leistungen" : "Capabilities"}</div><h1>${isDe ? "Fünf Dinge, die wir fertigen." : "Five things we build."}</h1><p>${esc(description)}</p></div></header><section class="section"><div class="container"><div class="journey-grid">${cards}</div></div></section></main>` + footer(root, lang);
}
