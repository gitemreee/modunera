...
function homePage(cfg, locales, pricing) {
  ...
  return (
    ...
    `<main id="main"><header class="hero"><div class="hero-media"></div><div class="hero-grain"></div><div class="container hero-content"><div class="hero-panel"><div class="hero-kicker">${esc(cfg.home.kicker)}</div><h1>${esc(cfg.home.h1)}</h1><p>${esc(cfg.home.intro)}</p><div class="hero-actions"><a class="btn btn-primary" href="${root}konfigurator/">${esc(cfg.labels.models)}</a><a class="btn btn-outline" href="${waLink(cfg.wa)}" target="_blank" rel="noopener">WhatsApp</a></div><div class="hero-proof"><span>8 ${esc(cfg.nav.models)}</span><span>${esc(cfg.labels.countries)}: 5</span><span>2,55 m</span></div></div></div></header>` +
